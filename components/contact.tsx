...
export default function Contant() {
    ...
    return (
        ...
        <motion.section ref={ref} id='contact' className='group mb-20 sm:mb-28 w-[min(100%, 38rem)] text-center'
            initial={{
                opacity: 0,
            }}
            whileInView={{
        ...
        >
            ...
            <form className='mt-10 flex flex-col dark:text-black' action={async (formData) => {
                ...
                <input
                    className='h-14 rounded-lg borderBlack pl-4 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all'
                    name='senderEmail'
                    type='email'
